    ...
    public function run()
    {
        ...
        for ($i=0; $i < 20000; $i++) { 
            Umat::create([
                ...
                'id_sts_sehat' => '00',
                'jen_kel' => rand(1,2),
                'id_pendidikan' => $temp_id_pendidikan[rand(0,24)],
                'tempat_lahir' => $temp_tmpat_lahir[rand(0,7)],
                'tgl_lahir' => '197'.rand(0,9).'-1'.rand(0,2).'-1'.rand(0,9),
                'id_wilayah' => rand(0,2) . rand(0,9),
                'tempat_baptis' => $temp_tmpat_baptis[rand(0,9)],
                'status_krisma' => $temp_status_krisma[rand(0,2)],
                'id_sts_kawin' => rand(0,1) . rand(0,9),
                'tgl_update' => '201' . rand(0,8) . '-0' . rand(1,9) . '-04 00:00:00',
            ]);
        }
    }
}
